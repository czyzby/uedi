...
public abstract class ContextTest {
    ...
    /** @return tested {@link Context} instance. */
    ...
    @Test
    public void shouldFindClassesWithExtendingInterfaces() {
        assertNotNull(context.get(InterfaceUser.class));
    }
    ...
    public void shouldNotInitiateAbstractClassesAndInterfaces() {
        assertEquals(context.get(InterfaceExtendingSingleton.class), context.get(InterfaceUser.class));
    ...
    public void shouldResolveAmbiguousDependencyGivenDefaultProvider() {
        ...
        assertTrue(context.get(List.class) instanceof ArrayList<?>);
    }
    ...
    public void shouldAddCustomProperty() {
        assertNull(context.getProperty("custom"));
